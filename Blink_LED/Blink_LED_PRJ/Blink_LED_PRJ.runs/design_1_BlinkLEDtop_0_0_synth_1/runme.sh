...
HD_PWD='C:/Users/ruc1p/Coding/3.Git/FPGA_Project/Blink_LED/Blink_LED_PRJ/Blink_LED_PRJ.runs/design_1_BlinkLEDtop_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_BlinkLEDtop_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_BlinkLEDtop_0_0.tcl
