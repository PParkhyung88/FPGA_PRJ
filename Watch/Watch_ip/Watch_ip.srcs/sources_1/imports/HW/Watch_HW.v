...
//
// Create Date:
// Design Name: Watch_HW
// Module Name: Watch_HW
// Project Name:
// Target Devices:
// Tool Versions:
// Description: watch module
// Dependencies:
//
// Revision:
...
parameter P_SEC_BIT = 6; // 2^6 = 64 (sec is under 60)
parameter P_MIN_BIT = 6; // 2^6 = 64 (min is under 60)
parameter P_HOUR_BIT = 5; // 2^5 = 32 (hour is under 24)
