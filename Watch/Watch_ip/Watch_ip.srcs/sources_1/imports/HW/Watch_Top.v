...
//
// Create Date:
// Design Name: Watch_Top
// Module Name: Watch_Top
// Project Name:
// Target Devices: Zybo Z7-20
// Tool Versions:
// Description: AXI4-LITE to control Watch_HW.
// Dependencies:
//
// Revision:
...
localparam P_SEC_BIT = 6; // 2^6 = 64 (sec is under 60)
localparam P_MIN_BIT = 6; // 2^6 = 64 (min is under 60)
localparam P_HOUR_BIT = 5; // 2^5 = 32 (hour is under 24)
